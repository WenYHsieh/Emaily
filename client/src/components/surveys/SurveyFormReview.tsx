...
const SurveyFormReview = (props: Props) => {
  ...
  return (
    <div className='px-[80px] py-[40px] w-[85%] my-[0px] mx-[auto]'>
      <h4 className='mb-8'>Please confirm your entries...</h4> {renderContent()}
      <div className='flex justify-between'>
        <button
          className='w-[100px] mt-[16px] text-white rounded-lg px-[16px] py-[8px] bg-[#e8516a] shadow hover:bg-[#ff3a68] transition-color duration-200'
          onClick={() => {
            setShowReview(false)
          }}
        >
